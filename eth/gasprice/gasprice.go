...
var (
	DefaultMaxPrice    = big.NewInt(500 * params.RhsGWei)
	DefaultIgnorePrice = big.NewInt(2 * params.RhsWei)

	DefaultMinSuggestedPriorityFee = big.NewInt(1e6 * params.RhsWei) // 0.001 gwei, for Optimism fee suggestion
)
